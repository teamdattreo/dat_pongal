...
export default function InstaFrameCameraImage({ className = "" }) {
  ...
  async function capture() {
    ...
    try {
      ...
      // Keep native orientation: portrait stays portrait, landscape stays landscape.
      const finalSnapshot = snapshotMirroredVideo(video, facing === "user");
      ...
      // Draw the final rotated photo without cropping
